...
2.  As suggested under *Workflow*, I created a new RStudio project (Version control) and entered the URL of the repository to clone it. This was my R version:

```{r Session Info}
print(sessionInfo())
```

3.  I installed the packages. Both failed to install due to my folder having a 00LOCK folder. I deleted the folder which led to the package successfully installing. neuroUP also installed dependency 'boostrap'.
...
3.  I opened figures-cohens_d.qmd and clicked on render at **11:33 CEST**. During the runtime I went back to the [CODECHECK documentation](https://codecheck.org.uk/guide/community-workflow). The Background Job quickly stalled at `16% [fig-1a]`. It increased to `48%` by 13:46 CEST. It was still `48%` at 15:47 CEST (after \~3.5 hours). A markdown file opened itself "**Code for Figures 1-2 based on Cohen's d**" after \~8 hours. The background job kept running. I stopped the job after more than 8 hours (8:33:40).
4.  I started rendering the code of the figures-correlations at 20:06 CEST. 48% after 1h. Accidentally stopped at 21:11 CEST, restarted. Finished at 22:47 CEST.
5.  I created a directory *codecheck* and saved this file in it.
6.  I could not write a Makefile to re-run the workflow.
7.  Visual inspection of the figures: I compared the four files fig-X-total-1 that include all other figures.
...
```{r fig-1-original, echo=FALSE, fig.align='center', fig.cap='Original figure', message=FALSE, out.width='0.6\\linewidth'}
knitr::include_graphics("../figures-cohens_d_files/figure-html/fig-1-total-1.png")
```

```{r fig-1-checked, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Reproduced figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../codecheck/figures/fig-1-total-1.png")
```


```{r fig-2-original, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Original figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../figures-cohens_d_files/figure-html/fig-2-total-1.png")
```

```{r fig-2-checked, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Reproduced figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../codecheck/figures/fig-2-total-1.png")
```


```{r fig-3-original, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Original figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../figures-correlations_files/figure-html/fig-3-total-1.png")
```

```{r fig-3-checked, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Reproduced figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../codecheck/figures/fig-3-total-1.png")
```


```{r fig-4-original, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Original figure', out.width='0.6\\linewidth'}
knitr::include_graphics("../figures-correlations_files/figure-html/fig-4-total-1.png")
```

```{r fig-4-checked, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Reproduced figure', out.width='0.6\\linewidth'}
