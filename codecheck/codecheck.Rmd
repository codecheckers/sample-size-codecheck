...
3.  I installed the packages. Both failed to install due to my folder having a 00LOCK folder. I deleted the folder which led to the package successfully installing. neuroUP also installed dependency 'boostrap'. I later also installed the float package hoping that this would result in the Codecheck image being displayed.
